...
ADD CONSTRAINT foreign_key_user_login_identifiers_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_user_preferences_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_user_auth_methods_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_password_credentials_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_webauthn_credentials_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_oauth_identities_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_totp_credentials_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_recovery_codes_user FOREIGN KEY (user_id) REFERENCES users (user_id);
...
ADD CONSTRAINT foreign_key_user_auth_policies_user FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE devices
ADD CONSTRAINT foreign_key_devices_user FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE device_webauthn_credentials
ADD CONSTRAINT foreign_key_device_webauthn_credentials_device FOREIGN KEY (device_id) REFERENCES devices (device_id);
...
ADD CONSTRAINT foreign_key_device_client_profiles_device FOREIGN KEY (device_id) REFERENCES devices (device_id);

ALTER TABLE device_client_profiles
ADD CONSTRAINT foreign_key_device_client_profiles_platform FOREIGN KEY (platform_id) REFERENCES platforms (platform_id);

ALTER TABLE sessions
ADD CONSTRAINT foreign_key_sessions_user FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE sessions
ADD CONSTRAINT foreign_key_sessions_device FOREIGN KEY (device_id) REFERENCES devices (device_id);
...
ADD CONSTRAINT foreign_key_session_tokens_session FOREIGN KEY (session_id) REFERENCES sessions (session_id);

ALTER TABLE refresh_tokens
ADD CONSTRAINT foreign_key_refresh_tokens_session FOREIGN KEY (session_id) REFERENCES sessions (session_id);

ALTER TABLE refresh_tokens
ADD CONSTRAINT foreign_key_refresh_tokens_session_token FOREIGN KEY (session_token_id) REFERENCES session_tokens (session_token_id);

ALTER TABLE refresh_tokens
ADD CONSTRAINT foreign_key_refresh_tokens_previous_token FOREIGN KEY (previous_refresh_token_id) REFERENCES refresh_tokens (refresh_token_id);
...
ADD CONSTRAINT foreign_key_login_attempts_user FOREIGN KEY (user_id) REFERENCES users (user_id);

ALTER TABLE login_attempts
ADD CONSTRAINT foreign_key_login_attempts_device FOREIGN KEY (device_id) REFERENCES devices (device_id);
...
ADD CONSTRAINT foreign_key_login_attempt_steps_attempt FOREIGN KEY (login_attempt_id) REFERENCES login_attempts (login_attempt_id);
